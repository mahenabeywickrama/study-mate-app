...
const tabs = [
  ...
  { name: "subjects", icon: "book", title: "Subjects" },
  { name: "tasks", icon: "list", title: "Tasks" },
  { name: "assignments", icon: "article", title: "Assignments" },
...
const DashboardLayout = () => {
  return (
    ...
    >
      ...
      /> */}
      {/* home.tsx */}
      {/* <Tabs.Screen name="subjects" /> subjects.tsx */}
      {/* <Tabs.Screen name="tasks" /> tasks.tsx */}
      {/* <Tabs.Screen name="assignments" /> assignments.tsx */}
